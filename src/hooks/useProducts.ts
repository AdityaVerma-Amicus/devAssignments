...
export function useProducts(): UseProductsResult {
    ...
    const pageCacheRef = useRef<Map<number, CachedPage>>(
        new Map()
    );
    ...
    const loadPage = async (
        ...
        try {
            ...
            /*
             * Normal pagination:
             * The API can directly handle search/category pagination.
             */
            ...
            /*
             * Category + Search:
             * The API category filter is applied first, then the
             * product name is filtered on the client.
             */
            ...
            const pageHasMore =
                startIndex + PAGE_SIZE < matchingProducts.length;
    ...
    const goToPage = async (page: number) => {
        ...
        const { searchTerm, category, sortBy, order } =
            filtersRef.current;
